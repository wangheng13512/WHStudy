#
#  Be sure to run `pod spec lint WHStudy.podspec' to ensure this is a
#  确保运行“pod spec lint WHStudy.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.name         = "WHStudy"
  s.version      = "0.0.0.1"
  s.summary      = "A short description of WHStudy."
  ...
  s.homepage     = "https://github.com/wangheng13512/WHStudy"
  ...
  s.source       = { :git => "https://github.com/wangheng13512/WHStudy.git", :tag => "#{s.version}" }
